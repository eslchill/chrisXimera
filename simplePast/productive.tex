...
\title{Simple Past - Productive 123}
\begin{document}
\begin{abstract}
...
Yesterday, Jim \answer{went} (go) to the store.\end{question}\begin{question} He \answer{needed} (need) to buy some groceries.\end{question}\begin{question} There \answer{was} (be) a big sale on cheese, so he \answer{bought} (buy) several wheels.\end{question}\begin{question} His reusable grocery bags \answer{were} (be) very heavy but he \answer{managed} (manage) to carry them home.\end{question}\begin{question} He \answer{ate} (eat) one wheel\end{solution}\begin{question} and \answer{put} (put) the others into his fridge.\end{question}\begin{solution} He \answer{survived} (survive) this experience, but barely.
